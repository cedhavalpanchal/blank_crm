...
use PayPal\Rest\ApiContext;
    ...
    */
    ...
    function genrate_unique_id($type)
    {
        $table = 'kube_master';
        ...
        $result = $CI->Common_function_model->getmultiple_tables($params);
        ...
        if(count($result) > 0)
        {
            $unique_id = explode(' - ', $result[0]['unique_id']);
            return $unique_id = $pretext.($unique_id[1]+1);
        }
        else
        {   
            return $unique_id = $pretext.'1';
        }
